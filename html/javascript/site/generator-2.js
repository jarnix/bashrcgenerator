var generator = {
    ...
    overElement : false,
    colorCodes : [ [ 37, '#FFF' ], [ 31, '#F00' ], [ 32, '#0F0' ], [ 33, '#FF0' ], [ 34, '#00F' ], [ 35, '#F0F' ], [ 36, '#0FF' ], [ 30, '#000' ] ],
    defaultColorCode : 37,
    ...
    fillPalette : function() {
        ...
        for ( var i in generator.colorCodes) {
            var colorEl = $('<div></div>').attr('data-color', generator.colorCodes[i][0]).addClass('color').css('backgroundColor', generator.colorCodes[i][1]).on('click', function(event) {
